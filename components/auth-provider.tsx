...
export function AuthProvider({ children }: { children: React.ReactNode }) {
              ...
              try {
                ...
                if (dbUser) {
                  ...
                  const updatedUser: AuthUser = {
                    ...
                    accent_dialect: (dbUser as any).accent_dialect,
                    accent_description: (dbUser as any).accent_description,
    ...
    try {
      ...
      await db.updateUser(foundUser.id, {
        ...
        const userSession: AuthUser = {
          ...
          accent_dialect: foundUser.accent_dialect || null,
          accent_description: foundUser.accent_description || null,
  ...
  const updateProfile = async (profile: Partial<AuthUser>) => {
    try {
      ...
      if ((profile as any).accent_description !== undefined) dbProfile.accent_description = (profile as any).accent_description
      ...
      if (updatedUser) {
        ...
        const userSession: AuthUser = {
          ...
          accent_dialect: (updatedUser as any).accent_dialect,
          accent_description: (updatedUser as any).accent_description,
