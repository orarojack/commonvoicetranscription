 ...
 * 
 * Usage:
 *   node scripts/remove_duplicate_reviews.js
 */

// Note: This requires the project to be built or running in a Node.js environment
// that supports ES modules and TypeScript imports
// For Next.js projects, you may need to use tsx or ts-node
